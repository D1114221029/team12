        ...
        for ($i = 0; $i < 10; $i++)//各別總計
        {
            ...
            ([
                [
                    ...
                    'total_people' => $wtotal_count+$Ftotal_count,//總計(人)
                    'political_staff'=> $Wgovernment+$Fgovernment,//政務人員數量
                    'senior_rank_staff'=> $Wsimple+$Fsimple,//簡任(派)人員數量
                    'recommended_rank_staff'=> $Wrecommended+$Frecommended,//薦任(派)
                    'appointed_rank_staff'=> $Wcommissioned+$Fcommissioned,//委任(派)
                ...
                [
                    ...
                    'total_people' => $wtotal_count,//總計(人)
                    'political_staff'=> $Wgovernment,//政務人員數量
                    'senior_rank_staff'=>  $Wsimple,//簡任(派)
                    'recommended_rank_staff'=> $Wrecommended,//薦任(派)
                    'appointed_rank_staff'=> $Wcommissioned,//委任(派)
                ...
                [
                    ...
                    'total_people' => $Ftotal_count,//總計(人)
                    'political_staff'=> $Fgovernment,//政務人員
